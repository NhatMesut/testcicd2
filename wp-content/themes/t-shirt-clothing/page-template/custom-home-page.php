...
<main id="content">
          ...
          <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
            ...
            <div class="carousel-caption slider-inner">
              ...
              <div class="home-btn my-4">
                <a class="py-md-3 px-md-4 py-2 px-3" href="<?php the_permalink(); ?>"><i class="fas fa-shopping-cart me-3"></i><?php echo esc_html(get_theme_mod('t_shirt_clothing_slider_read_more',__('Shop Now','t-shirt-clothing'))); ?></a>
              </div>
            </div>
          </div>
          <?php $i++; endwhile;
  ...
  <?php }?>
  <?php if( get_option('t_shirt_clothing_product_cat_enable') == '1'){ ?>
    <?php if( get_theme_mod('t_shirt_clothing_product_category_subtitle') != '' || get_theme_mod('t_shirt_clothing_product_category_title') != '' || get_theme_mod('t_shirt_clothing_category_setting') != ''){ ?>
      <div id="pro_cat" class="py-5 text-center">
        <div class="container">
          <?php if( get_theme_mod('t_shirt_clothing_product_category_title') != ''){ ?>
            <h3><?php echo esc_html(get_theme_mod('t_shirt_clothing_product_category_title','')); ?></h3>
          <?php }?>
          <?php if( get_theme_mod('t_shirt_clothing_product_category_subtitle') != ''){ ?>
            <p><?php echo esc_html(get_theme_mod('t_shirt_clothing_product_category_subtitle','')); ?></p>
          <?php }?>

          <div class="row">
            <?php
            $t_shirt_clothing_catData1=  get_theme_mod('t_shirt_clothing_category_setting');if($t_shirt_clothing_catData1){
            $t_shirt_clothing_page_query = new WP_Query(array( 'category_name' => esc_html($t_shirt_clothing_catData1 ,'t-shirt-clothing')));?>
              <?php while( $t_shirt_clothing_page_query->have_posts() ) : $t_shirt_clothing_page_query->the_post(); ?>
                <div class="col-lg-4 col-md-4 ps-lg-2 p ps-0">
                  <div class="pro_box mb-3 wow zoomIn">
          ...
          <div class="row">
            ...
            <?php if( get_theme_mod('clothing_store_millions_of_hours_countdown_timer') != '' ){ ?>
              <div id="countdown-timer" class="text-center">
                ...
                <div class="time-box me-2 me-lg-3"><strong id="days" class="bold-number">118 </strong> <p class="slim-countdown-text mb-0"><?php esc_html_e('Days','t-shirt-clothing'); ?></p><span class="timer"></span></div>
                <div class="time-box me-2 me-lg-3"><strong id="hours" class="bold-number"> 14 </strong> <p class="slim-countdown-text mb-0"><?php esc_html_e('Hours','t-shirt-clothing'); ?></p><span class="timer"></span></div>
                <div class="time-box me-2 me-lg-3"><strong id="mins" class="bold-number"> 36 </strong> <p class="slim-countdown-text mb-0"><?php esc_html_e('Minutes','t-shirt-clothing'); ?></p><span class="timer"></span></div>                
                <div class="time-box"><strong id="seconds" class="bold-number"> 24 </strong> <p class="slim-countdown-text mb-0"><?php esc_html_e('Seconds','t-shirt-clothing'); ?></p><span class="timer"></span></div>
              </div>
            <?php }?>
          </div>
          </div>
